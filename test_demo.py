...
def main():
    ...
    parser.add_argument('--hidden_size', default=230, type=int,
           help='hidden size')
    parser.add_argument('--load_ckpt', default='checkpoint/proto-cnn-train_wiki-val_pubmed-5-5-adv_pubmed_unsupervised.pth.tar',
           help='load ckpt')
    ...
    if model_name == 'proto':
        model = Proto(sentence_encoder, K, hidden_size=opt.hidden_size)
    elif model_name == 'gnn':
