    ...
    def train(self,
        ...
        for it in range(start_iter, start_iter + train_iter):
            ...
            if self.adv:
                ...
                features_ori = l2norm(features_ori)
                features_adv = l2norm(features_adv)
                '''
                if flg == 0:
                    print(features_ori)
                    print(features_adv)
        ...
        with torch.no_grad():
            for it in range(eval_iter):
                ...
                if mark <= 4:
                    ...
                    f.write(str(pred)+'\n')
                    f.write("right:")
                    right = right.cpu().detach().numpy()
                    f.write(str(right)+'\n')
                    f.write("iter_right:")
                    f.write(str(iter_right)+'\n')
                    f.write("iter_sample:")
                    f.write(str(iter_sample)+'\n')
                    f.close()                    
                    mark += 1
                    '''
